...
class ChildDetailsViewController: BaseViewController {
    ...
    var tasksViewModels = [ChildDetailsModels.ViewModels.TaskDetails(id: 1, taskType: "housekeeping", taskTitle: "Tidy up your room", amount: "LBP 100,000", status: "Completed by Micheal", childImage: R.image.boyPicture.name, actionTitle: "Pay off"), ChildDetailsModels.ViewModels.TaskDetails(id: 2, taskType: "pets", taskTitle: "Walk the dog", amount: "LBP 75,000", status: "Assigned to Micheal", childImage: R.image.boyPicture.name, actionTitle: "Pending"), ChildDetailsModels.ViewModels.TaskDetails(id: 3, taskType: "gardening", taskTitle: "Water the plants outside", amount: "LBP 200,000", status: "Completed by Micheal", childImage: R.image.boyPicture.name, actionTitle: "Pay off")]
