...
public protocol IntroductionControllerDelegate: AnyObject {
    func introductionController(_ controller: OnboardingController, willDisplay index: Int)
    func introductionController(_ controller: OnboardingController, didEndDisplaying index: Int)
...
public class OnboardingController: UIViewController {
    ...
    private let config: OnboardingConfig
    
    public init(config: OnboardingConfig = OnboardingConfig()) {
        self.config = config
...
extension OnboardingController: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "IntroductionCell", for: indexPath) as! OnboardingCollectionViewCell
...
extension OnboardingController: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
