...
public extension Response {
    ...
    public func mapObject<T: BaseMappable>(_ type: T.Type, context: MapContext? = nil, atKeyPath keyPath : String? = nil) throws -> T {
        ...
        guard let customJSONDictionary = jsonDictionary[keyPath!] as? [String : Any] else {
            throw MoyaError.jsonMapping(self)
        }
    ...
    /// protocol.
    /// If the conversion fails, the signal errors.
    public func mapArray<T: BaseMappable>(_ type: T.Type, context: MapContext? = nil, atKeyPath keyPath : String? = nil ) throws -> [T] {
        ...
        return  Mapper<T>(context: context).mapArray(JSONArray: customJSONDictionary)
